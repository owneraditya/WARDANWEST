-- ============================================================
-- MODDED BY WARDENBEAST + @WARDENBEAST
...
-- Bypass integrated from WARDENBEAST Ultimate Shield
-- ============================================================
...
pcall(function()
    ...
    local function onClick() if Web then Web:OpenURL("https://t.me/WARDENBEAST") end end
    if Msg and Msg.Show then
        Msg.Show(4, "✦ WARDENBEAST – ELITE ULTIMATE ✦",
        "\n★ Developer : @WARDENBEAST\n" ..
        "★ Status    : UNDETECTED & OPTIMIZED\n" ..
        "★ Bypass    : 16‑Layer Ultimate Shield\n" ..
        "★ WARDENBEAST  : Always On Fire\n\n" ..
